...
<div class="container elam-green">
    <h1 class="page-title">Etablissement secondaire</h1>

    <div id="main-content">
        <div class="row">
            <div class="col-sm-9 job-details">
                <h2 class="section-title job-title">Présentation</h2>

                <div class="detail-field job-detail">
                    <div class="row">
                        <div class="col-sm-8">
                            <h3 class="field-title">Statut de l'établissement</h3>
                            <span class="li">Privé sous contrat</span>
                        </div>
                ...
                <div class="detail-field job-detail">
                    <h3 class="field-title">Type d'établissement</h3>
                    <span class="li">Privé sous contrat</span>
                </div>

                <div class="detail-field job-detail">
                    <h3 class="field-title">Présentation</h3>
                ...
                <div class="detail-field job-detail">
                    <h3 class="field-title">Effectifs</h3>
                ...
                <div id="block-googlemap">
                    <div id="map-details">
                        ...
                        <ul>
                            <li class="address">917, Rue Alsace Lorraine, Montagne Sainte</li>
                            <li class="tel">(+241) 00 00 00 00</li>
                            <li class="mail">infos@afram.com</li>
                            <li class="coo">Long: N/A - Lat: N/A</li>
                            <li class="web">www.afram.com</li>
                        </ul>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-9 job-details">
                ...
                <div class="detail-field job-detail">
                    <h3 class="field-title">Galerie</h3>
                        ...
                        <div class="owl-carousel owl-theme">
                            <?php for ($i = 2; $i <= 8; $i++): ?>
                                <div class="slide">
                                    ...
                                    <span class="the-title">Titre de l'image</span>
                                </div>
                            <?php endfor; ?>
                        </div>
                    </div>
