    ...
    <div id="main-content">
        <div class="row">
            <div class="col-sm-9 job-details">
                <h2 class="section-title job-title">Employé de rayon boucherie H/F</h2>

                <div class="detail-field job-detail">
                    <div class="row">
                        <div class="col-sm-8">
                            <h3 class="field-title">Recruteur</h3>
                            <span class="li">San Gel OKALA</span>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="img/sponsors/2.jpg" alt="logo" class="img-responsive">
                        </div>
                    </div>
                </div>

                <div class="detail-field job-detail">
                    <h3 class="field-title">Domaine d'activité</h3>
                    <span class="li">Commerce - Distribution (Grand distribution)</span>
                </div>
        ...
        <div class="row">
            <div class="col-sm-9 job-details">
                ...
                <div class="detail-field job-detail">
                    <h3 class="field-title">Durée</h3>

                    <span class="li">Indéterminée</span>
